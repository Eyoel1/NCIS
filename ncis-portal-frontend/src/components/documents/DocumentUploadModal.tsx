      ...
      <div className="space-y-5">
        ...
        {!fileSelected ? (
          <div
            ...
            className="border-2 border-dashed border-slate-700 hover:border-sky-500/70 bg-slate-950/60 p-8 rounded-xl flex flex-col items-center justify-center text-center cursor-pointer transition-all group"
          >
            <div className="p-3 rounded-full bg-slate-900 border border-slate-800 text-sky-400 group-hover:scale-110 transition-transform mb-3">
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="text-xs font-bold text-white block">{fileSelected}</span>
          ...
          <div className="bg-slate-950 rounded-xl border border-slate-800 p-4 space-y-3">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 text-xs font-mono">
              {Object.entries(extractedData).map(([key, val]) => (
                <div key={key} className="bg-slate-900/80 p-2 rounded border border-slate-800/60">
